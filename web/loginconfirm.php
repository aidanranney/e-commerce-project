...
$privQuery = "SELECT privCheck from USER_ACCOUNT WHERE USEREMAIL='$useremail' AND password='$hashed'";
//run query. the @ symbol suppresses errors
$privacy = @mysqli_query($link, $privQuery);
...
if (mysqli_num_rows($row) == 1) {
	...
	echo '$_SESSION['privacy'] $_SESSION['admin']';
